...
void Parser::displayHelpTexts()
{
    ...
    std::cout << "  ziply create -f example.png -o zipled -r 1080p -p mySecret -c 8\n"
              << "    Converts 'example.png' into 'zipled.mp4' at 1080p resolution, encrypted with 'mySecret', with a pixel-to-bit ratio of 8.\n";
